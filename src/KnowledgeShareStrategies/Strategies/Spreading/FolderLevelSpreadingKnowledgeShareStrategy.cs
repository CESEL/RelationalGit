...
{
    public class FolderLevelSpreadingKnowledgeShareStrategy : KnowledgeShareStrategy
    {
        ...
        private DeveloperKnowledge[] GetFolderLevelOweners(PullRequestContext pullRequestContext)
        {
            ...
            var prKnowledgeables = pullRequestContext.AvailablePRKnowledgeables().Where(q => folderLevelKnowlegeables.All(f => f.DeveloperName != q.DeveloperName));
